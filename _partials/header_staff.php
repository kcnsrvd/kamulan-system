...
// Determine correct dashboard & profile paths based on role
switch ($role) {
  case 'staff':
    $homeLink    = "/kamulan-system/staff/dashboard.php";
    $profileLink = "/kamulan-system/staff/profile.php";
    break;
  case 'rider':
    $homeLink    = "/kamulan-system/rider/dashboard.php";
    $profileLink = "/kamulan-system/rider/profile.php";
    break;
  case 'admin':
  case 'manager':
    $homeLink    = "/kamulan-system/admin/dashboard.php";
    $profileLink = "/kamulan-system/admin/profile.php";
    break;
  default:
    $homeLink    = "/kamulan-system/index.php";
    $profileLink = "/kamulan-system/index.php";
    break;
}
?>
...
">
  ...
  <nav class="nav" style="display: flex; align-items: center; gap: 25px;">
    ...
    <a href="<?= $profileLink ?>" class="nav-link">Profile</a>
