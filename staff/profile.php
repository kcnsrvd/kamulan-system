...
<main class="profile-page">
  <div class="profile-header">
    <div>
      ...
      <p class="profile-sub">Update your account details and password.</p>
    </div>
  </div>
  ...
  <div class="profile-grid">
    <section class="profile-card">
      ...
      <p class="meta-row"><span class="meta-label">Role:</span> <?= htmlspecialchars(ucfirst($user['role'] ?? 'staff')) ?></p>
    ...
    <section class="profile-card">
      ...
      <form method="post" onsubmit="return confirm('This will permanently delete your staff account. Continue?');">
