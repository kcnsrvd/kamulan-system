...
<main class="profile-page">
  <div class="profile-header">
    <div>
      ...
      <p class="profile-sub">Manage your administrator account information.</p>
    </div>
  </div>
  ...
  <div class="profile-grid">
    <section class="profile-card">
      ...
      <p class="meta-row"><span class="meta-label">Role:</span> <?= htmlspecialchars(ucfirst($user['role'] ?? 'manager')) ?></p>
      <p class="meta-row"><span class="meta-label">Branch:</span> <?= htmlspecialchars($user['branch_name'] ?? 'All branches') ?></p>
    ...
    <section class="profile-card">
      ...
      <form method="post" onsubmit="return confirm('This will permanently delete your admin account. Continue?');">
