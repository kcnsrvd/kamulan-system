...
// --- Fetch quick stats (net sales exclude delivery fee, which goes to riders) ---
$today_sales = $pdo->query(" 
    SELECT COALESCE(SUM(total - delivery_fee), 0)
    FROM orders
...
// --- Query orders from current month ---
$query = " 
  SELECT 
    o.id, 
    CONCAT(u.first_name, ' ', u.last_name) AS customer, 
...
<div class="container">
  ...
  <div class="links">
    ...
    <a href="/kamulan-system/admin/manage_home_photos.php">Manage Home Photos</a>
  </div>
